...
struct Item* push_item(struct Token_list* list, struct Item* after, char token)
{
...
void clear_list(struct Token_list* list)
{
...
void delete_list(struct Token_list* list)
{
	if(list==NULL)
		return;
	clear_list(list);
